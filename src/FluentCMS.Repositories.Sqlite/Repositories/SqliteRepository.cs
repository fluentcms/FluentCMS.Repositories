...
/// <summary>
/// SQLite implementation of the generic repository pattern using Entity Framework Core.
/// </summary>
/// <typeparam name="T">The type of entity that implements IBaseEntity.</typeparam>
public class SqliteRepository<T> : IBaseEntityRepository<T> where T : class, IBaseEntity
{
    ...
    public SqliteRepository(FluentCmsDbContext context)
    {
        _context = context;
